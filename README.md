...
Aluno(s): Ellen Vitorino Turma: S.I 05.1 Professor: Rafael Data: 08/04/2026
...
leitura do arquivo nlp_features_train.csv;
limpeza e tokenização das perguntas da coluna question1;
comparação entre todos os pares possíveis de perguntas;
cálculo da similaridade de Jaccard para cada par.
...
executar a versão serial do programa;
executar a versão paralela com 2, 4, 8 e 12 processos MPI;
registrar o tempo total de execução em cada configuração;
usar o tempo da versão serial como base para o cálculo de speedup e eficiência.
